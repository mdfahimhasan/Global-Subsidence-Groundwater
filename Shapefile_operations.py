...
def shapefile_to_raster(input_shape_fp, output_dir,shp_field_pos=1, xres=0.05, yres=0.05, gdal_path='C:\\OSGeo4W64\\'):
    ...
    :param xres,yres : cell size of the output raster; default 0.05
    ...
    rasterize_arg=['-l',layer_name,'-a',value_field,'-tr',str(xres),str(yres),'-te',str(minx),str(miny), str(maxx), str(maxy),
