Python scripts for a ML model to generate global map of subsidence (~2 km rsoultion) induced by groundwater pumping. The scripts include codes for automatic data 
